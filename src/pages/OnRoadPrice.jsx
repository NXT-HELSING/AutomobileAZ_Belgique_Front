    ...
    return (
        <>
            <div className="page-content bg-white">
                <CarlistingBanner img={IMAGE.bnr1} title={'Get On Road Price'} />
                {/* ================Next section >>>>>>>> */}
                                ...
                                <div className="contact-area1">
                                    <form className="dlab-form style-1 dzForm" method="POST" action="script/contact_smtp.php">
                                        ...
                                        <div className="row sp10">
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    ...
                                                    <div className="input-group">
                                                        <input type="text" className="form-control" required name="dzName" placeholder="Your Name" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    ...
                                                    <div className="input-group">
                                                        <input type="text" className="form-control" required name="dzOther[Mobile]" placeholder="Mobile" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    <label className="font-weight-600">City</label>
                                                    <div className="input-group">
                                                        <input type="text" className="form-control" required name="dzOther[City]" placeholder="City" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    <label className="font-weight-600">Pin Code</label>
                                                    <div className="input-group">
                                                        <input type="text" className="form-control" required name="dzOther[Pin_Code]" placeholder="Pin Code" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    <label className="font-weight-600">Select Brand</label>
                                                    <div className="input-group">
                                                        <Form.Select className="form-control cursorPointer" required>
                                            ...
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    <label className="font-weight-600">Select Model</label>
                                                    <div className="input-group">
                                                        <Form.Select className="form-control cursorPointer" required>
                                            ...
                                            <div className="col-sm-12">
                                                <button name="submit" type="submit" value="submit" className="btn btn-primary w-100 d-block btn-rounded">Show On Road Price</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
