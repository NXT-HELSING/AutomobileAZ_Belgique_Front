                ...
                <section className="content-inner-2">
                    <div className="container">
                        <div className="section-head text-center">
                            <h2 className="title">Nos points de vente</h2>
                            <p>Retrouvez AutomobileAZ à Meise, facilement accessible depuis Bruxelles, Vilvoorde et toute la Belgique. Notre showroom vous accueille du lundi au samedi.</p>
                        </div>
                ...
                <section className="content-inner-2">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-5 me-auto">
                                <div className="section-head">
                                    <h6 className="text-primary sub-title">ÉQUIPE</h6>
                                    <h2 className="title">Notre équipe</h2>
                                </div>
                            </div>
                            <div className="col-lg-6 m-b30">
                                <p>Une équipe passionnée, expérimentée et à votre écoute. Nos conseillers vous accompagnent dans votre recherche du véhicule idéal, avec professionnalisme et bienveillance.</p>
                            </div>
                        </div>
                        {swiperWidth === false &&
